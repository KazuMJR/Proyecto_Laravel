...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Lista de Transportes</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('transportes.edit', $transporte) }}" class="btn btn-sm btn-warning me-2">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <form action="{{ route('transportes.destroy', $transporte) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Estás seguro de eliminar este transporte?')">
                            @csrf
                            @method('DELETE')
